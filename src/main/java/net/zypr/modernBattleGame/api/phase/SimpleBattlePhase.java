...
public final class SimpleBattlePhase<T extends BattleGame<?>> implements BattlePhase<T> {
    ...
    public SimpleBattlePhase(Consumer<T> initExecution,
                             Function<T, Boolean> loopExecution,
                             Timer timer) {
    ...
    public Consumer<T> initExecution() {
        return initExecution;
    }

    public Function<T, Boolean> loopExecution() {
        return loopExecution;
    }
